...
public class ShooterWorld extends World
{
    ...
    protected boolean wPressed = false;  //boolean for key pressed check
    protected boolean aPressed = false;  //boolean for key pressed check
    protected boolean sPressed = false;  //boolean for key pressed check
    protected boolean dPressed = false;  //boolean for key pressed check
    ...
    public void checkForPlayerMovement() {
        //short cut keys for key pressed
        wPressed = Greenfoot.isKeyDown ("w") || Greenfoot.isKeyDown ("W");
        aPressed = Greenfoot.isKeyDown ("a") || Greenfoot.isKeyDown ("A");
        sPressed = Greenfoot.isKeyDown ("s") || Greenfoot.isKeyDown ("S");
        dPressed = Greenfoot.isKeyDown ("d") || Greenfoot.isKeyDown ("D");
    }
    
    public void update() {
        score.addToScore();  //Calls method to add to score in scoreboard class
    }
}